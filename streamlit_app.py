...
st.dataframe(
    ...
    column_config={
        ...
        "% Rate of Job Loss Tier 1 Jobs": st.column_config.NumberColumn(format="%.1f%%", width="100px", label="T1 Job Loss Rate (%)"),
        ...
        "% Rate of Job Loss Tier 2 Jobs": st.column_config.NumberColumn(format="%.1f%%", width="100px", label="T2 Job Loss Rate (%)"),
